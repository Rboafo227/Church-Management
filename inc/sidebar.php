 <div id="sidebar-main" class="sidebar sidebar-default">
   <div class="sidebar-content">
     <ul class="navigation">
       ...
       <li>
         <a href="member.php"><i class="fa fa-pencil"></i> <span>Add Member</span></a>
       </li>

       <li>
         <a href="offering.php"><i class="fa fa-money"></i> <span>Add Tithes & Offerings</span></a>
       </li>
       ...
       <li>
         ...
         <ul>
           ...
           <li><a href="pastors.php">Pastors Directory</a></li>
           <li><a href="churches.php">Church Directory</a></li>
