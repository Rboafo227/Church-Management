                ...
                <div class="col-lg-12">
                    <div class="login card auth-box mx-auto my-auto">
                        <div class="card-block text-center">
                            ...
                            <h4 class="text-light">Deliverance Church Admin Login</h4>
                                ...
                                <div class="user-details">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="password" placeholder="Password" id="myInput" aria-describedby="basic-addon1">
                                        </div>
                                    </div>
                                    <div class="form-group">
